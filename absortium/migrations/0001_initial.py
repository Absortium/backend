# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-07-20 17:11
from __future__ import unicode_literals

import absortium.mixins.model
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', models.CharField(max_length=4)),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='deposits', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='MarketInfo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='absortium.Order')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to=settings.AUTH_USER_MODEL)),
            ],
            bases=(models.Model, absortium.mixins.model.OrderMixin),
        ),
        migrations.CreateModel(
            name='Withdrawal',
            fields=[
